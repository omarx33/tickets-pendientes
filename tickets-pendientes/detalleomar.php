<div class="modal fade" id="<?php echo $tomar['idticket_cab']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
              Usuario: <br>
              <input type="text" value="<?php echo $tomar['fullname']?>" class="form-control" readonly >

            </div>

            <div class="col-md-6">
              Area: <br>
              <input type="text" value="<?php echo $tomar['descripcion']?>" class="form-control" readonly >
              <br>
            </div>
            <br>
          ...
          <div class="col-md-6">
          Fecha de registro:
          <input type="text" value="<?php echo $tomar['fecha_creacion']?>" class="form-control" readonly>
          <br>
          </div>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" value="<?php echo $tomar['fecha_asignacion']?>" readonly>
              <br>
          </div>

          <?php
            $datetime2 = new DateTime($tomar['fecha_asignacion']);
 ...
 $interval->format('%R%a días, %h Horas');
  ...
  <br>
          ...
          <textarea name="" id="" cols="30" rows="10"  class="form-control" readonly>
            <?php echo utf8_decode($tomar['detalle'])?>
          </textarea>
            </div>
