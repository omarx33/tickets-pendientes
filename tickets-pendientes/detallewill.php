<div class="modal fade" id="<?php echo $twillian['idticket_cab']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Detalles - <?php echo 'Ticket: '.$twillian['idticket_cab'] ?></h4>
      </div>
      <div class="modal-body">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
              Usuario: <br>
              <input type="text" value="<?php echo $twillian['fullname']?>" class="form-control" readonly >

            </div>

            <div class="col-md-6">
              Area: <br>
              <input type="text" value="<?php echo $twillian['descripcion']?>" class="form-control" readonly >
              <br>
            </div>
            <br>
          ...
          <div class="col-md-6">
          Fecha de registro:
          <input type="text" value="<?php echo $twillian['fecha_creacion']?>" class="form-control" readonly>
          <br>
          </div>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" value="<?php echo $twillian['fecha_asignacion']?>" readonly>
              <br>
          </div>
            ...
            <?php
              $datetime2 = new DateTime($twillian['fecha_asignacion']);
...
<br>
          ...
          <textarea name="" id="" cols="30" rows="10"  class="form-control" readonly>
            <?php echo utf8_decode($twillian['detalle'])?>
          </textarea>
            </div>
