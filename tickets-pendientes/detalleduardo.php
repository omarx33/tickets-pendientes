<div class="modal fade" id="<?php echo $teduardo['idticket_cab']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
              Usuario: <br>
              <input type="text" value="<?php echo $teduardo['fullname']?>" class="form-control" readonly >

            </div>

            <div class="col-md-6">
              Area: <br>
              <input type="text" value="<?php echo $teduardo['descripcion']?>" class="form-control" readonly >
              <br>
            </div>
            <br>
          ...
          <div class="col-md-6">
          Fecha de registro:
          <input type="text" value="<?php echo $teduardo['fecha_creacion']?>" class="form-control" readonly>
          <br>
          </div>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" value="<?php echo $teduardo['fecha_asignacion']?>" readonly>
              <br>
          </div>
          ...
          <div class="col-md-12">
            ...
            <?php
              $datetime2 = new DateTime($teduardo['fecha_asignacion']);
  ...
  <?php } elseif ($interval->format('%R%a') == '0' And $interval->format('%h') >= '0' ){ ?>
    ...
    <br>
          ...
          <textarea name="" id="" cols="30" rows="10"  class="form-control" readonly>
            <?php echo utf8_decode($teduardo['detalle'])?>
          </textarea>
            </div>
