<div class="modal fade" id="<?php echo $tmarco['idticket_cab']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-6">
              Usuario: <br>
              <input type="text" value="<?php echo utf8_decode($tmarco['fullname'])?>" class="form-control" readonly >

            </div>

            <div class="col-md-6">
              Area: <br>
              <input type="text" value="<?php echo $tmarco['descripcion']?>" class="form-control" readonly >
              <br>
            </div>
            <br>
          ...
          <div class="col-md-6">
          Fecha de registro:
          <input type="text" value="<?php echo $tmarco['fecha_creacion']?>" class="form-control" readonly>
          <br>
          </div>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" value="<?php echo $tmarco['fecha_asignacion']?>" readonly>
              <br>
          </div>
                      ...
                      <?php
                        $datetime2 = new DateTime($tmarco['fecha_asignacion']);
          ...
          <textarea name="" id="" cols="30" rows="10"  class="form-control" readonly>
            <?php echo rtrim(ltrim(utf8_decode($tmarco['detalle'])))?>
          </textarea>
            </div>
